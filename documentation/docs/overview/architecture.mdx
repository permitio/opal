...
<img src="https://i.ibb.co/CvmX8rR/simplified-diagram-highlight.png" alt="simplified" border="0"></img>


## In Depth Architecture (Components diagram)

<img src="https://i.ibb.co/F45Q7bC/main-numbered.png" alt="main-numbered" border="0"></img>
