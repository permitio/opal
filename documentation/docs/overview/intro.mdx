...
- OPAL is the easiest way to keep your solution's authorization layer up-to-date in realtime.
  ...
  - OPAL is microservices and cloud-native (see [Key concepts and design](design))
...
- Large scale Global FGA:
  ...
  - Currently OPAL is not meant for managing ridiculous (>100GB) amounts of data within one layer. Though it can complement a CDN to achieve a similar result - see [Key concepts and design](design#"large-scale-fga).
