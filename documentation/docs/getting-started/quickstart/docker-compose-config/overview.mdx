...
The example file we will be referring to in this guide can be seen **[here](https://github.com/permitio/opal/blob/master/docker/docker-compose-example.yml)**. If you prefer Alpine-based containers, see the alternative compose file **[here](https://github.com/permitio/opal/blob/master/docker/docker-compose-example-alpine.yml)**.
