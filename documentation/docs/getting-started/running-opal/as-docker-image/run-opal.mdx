...
Env Var Name | Function
:--- | :---
OPAL_DATA_CONFIG_SOURCES | Directives on **how to fetch** the data configuration we load into OPA cache when OPAL client starts, **where to put it**, and optionally if it should periodically pull from this source.
