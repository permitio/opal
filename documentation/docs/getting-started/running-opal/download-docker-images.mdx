...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td valign="top">
        <code>docker pull permitio/opal-server</code><br />
        <code>docker pull permitio/opal-server:latest-alpine</code>
      </td>
      <td valign="top">
        <ul>
    ...
    <tr>
      ...
      <td valign="top">
        <code>docker pull permitio/opal-client</code><br />
        <code>docker pull permitio/opal-client:latest-alpine</code>
      </td>
      <td valign="top">
        <ul>
    ...
    <tr>
      ...
      <td valign="top">
        <code>docker pull permitio/opal-client-standalone</code><br />
        <code>docker pull permitio/opal-client-standalone:latest-alpine</code>
      </td>
      <td valign="top">
        <ul>
          <li>
