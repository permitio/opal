...
### I have generated 1.3mln records (or ~150MB) of "permissions" data (zipped and uploaded to g-drive), and served this file as an input data with a python http server.
...
**Could you please advice what could be done to improve or is it just like how it works?**
