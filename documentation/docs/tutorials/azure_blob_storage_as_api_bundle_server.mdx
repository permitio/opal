...
| OPAL_BLOB_ACCOUNT_URL         | The Secret Token (AKA password, AKA secret-key) sent to the API bundle server.                                                                                                  | https://opalpolicybundleserver43dke.blob.core.windows.net                                |
