...
[You can learn how to generate your OPAL client token here](/getting-started/get_started_with_opal_using_docker#step-2-obtain-client-jwt-token-optional).
...
This is how a typical configuration of `OPAL_DATA_CONFIG_SOURCES` looks like: ([a breakdown of this config can be found here](/getting-started/get_started_with_opal_using_docker#step-5-server-config---data-sources))
