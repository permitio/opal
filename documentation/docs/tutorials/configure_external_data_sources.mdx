...
[You can learn how to generate your OPAL client token here](/getting-started/running-opal/as-docker-image/run-opal-client/obtain-jwt-token).
...
This is how a typical configuration of `OPAL_DATA_CONFIG_SOURCES` looks like: ([a breakdown of this config can be found here](/getting-started/running-opal/as-docker-image/run-opal-server/data-sources))
