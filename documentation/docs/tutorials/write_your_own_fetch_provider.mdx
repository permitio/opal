...
We measured this rather than guessed: eleven realistic v1-era provider shapes
were run under both pydantic versions. **Exactly two require you to change
code**, and everything else keeps working.
...
| inner `class Config` | works; prefer `model_config = ConfigDict(...)` |
