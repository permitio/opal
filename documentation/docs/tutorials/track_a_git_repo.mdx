...
Pass the secret as config when [running OPAL Server](/getting-started/get_started_with_opal_using_docker#step-7-putting-it-all-together---running-the-server):
