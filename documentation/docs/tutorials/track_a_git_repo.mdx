...
Pass the secret as config when [running OPAL Server](/getting-started/running-opal/as-docker-image/run-opal#step-7-putting-it-all-together---running-the-server):
