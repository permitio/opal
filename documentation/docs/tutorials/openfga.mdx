...
[OpenFGA](https://openfga.dev) is an open-source Fine-Grained Authorization (FGA) engine implementing the Zanzibar authorization model created by Google. OPAL provides realtime synchronization and management capabilities for OpenFGA, helping you keep your authorization data and relationships up-to-date across distributed OpenFGA instances.
...
- **Data Source Integration**:
  - Pull relationship data from multiple sources:
    ...
    - Databases
    - Message queues
    - Custom data sources via OPAL fetchers
