...
class OpalCommonConfig(Confi):
    ALLOWED_ORIGINS = confi.list("ALLOWED_ORIGINS", ["*"], description="List of allowed origins for CORS")
    ...
    LOG_TRACEBACK = confi.bool("LOG_TRACEBACK", True, description="Include traceback in log messages")
    LOG_DIAGNOSE = confi.bool("LOG_DIAGNOSE", True, description="Include diagnosis in log messages")
    LOG_COLORIZE = confi.bool("LOG_COLORIZE", True, description="Colorize log messages")
    LOG_SERIALIZE = confi.bool("LOG_SERIALIZE", False, description="Serialize log messages")
    LOG_SHOW_CODE_LINE = confi.bool("LOG_SHOW_CODE_LINE", True, description="Show code line in log messages")
    #  - log level
    ...
    LOG_FILE_ROTATION = confi.str("LOG_FILE_ROTATION", "250 MB", description="Log file rotation size")
    LOG_FILE_RETENTION = confi.str("LOG_FILE_RETENTION", "10 days", description="Log file retention time")
    LOG_FILE_COMPRESSION = confi.str("LOG_FILE_COMPRESSION", None, description="Log file compression format")
    LOG_FILE_SERIALIZE = confi.str("LOG_FILE_SERIALIZE", True, description="Serialize log messages in file")
    LOG_FILE_LEVEL = confi.str("LOG_FILE_LEVEL", "INFO", description="The log level to show in file")
