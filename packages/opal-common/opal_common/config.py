...
class OpalCommonConfig(Confi):
    ...
    OAUTH2_CLIENT_ID = confi.str("OAUTH2_CLIENT_ID", None, description="OAuth2 Client ID.")
    OAUTH2_CLIENT_SECRET = confi.str("OAUTH2_CLIENT_SECRET", None, description="OAuth2 Client Secret.")
    OAUTH2_TOKEN_URL = confi.str("OAUTH2_TOKEN_URL", None, description="OAuth2 Token URL.")
    OAUTH2_INTROSPECT_URL = confi.str("OAUTH2_INTROSPECT_URL", None, description="OAuth2 introspect URL.")
    OAUTH2_OPENID_CONFIGURATION_URL = confi.str("OAUTH2_OPENID_CONFIGURATION_URL", None, description="OAuth2 OpenID configuration URL.")
    OAUTH2_TOKEN_VERIFY_CACHE_MAXSIZE = confi.int("OAUTH2_TOKEN_VERIFY_CACHE_MAXSIZE", 100, description="OAuth2 token validation cache maxsize.")
    OAUTH2_TOKEN_VERIFY_CACHE_TTL = confi.int("OAUTH2_TOKEN_VERIFY_CACHE_TTL", 5 * 60, description="OAuth2 token validation cache TTL.")
    ...
    OAUTH2_JWT_AUDIENCE = confi.str("OAUTH2_JWT_AUDIENCE", None, description="OAuth2 required audience")
    OAUTH2_JWT_ISSUER = confi.str("OAUTH2_JWT_ISSUER", None, description="OAuth2 required issuer")
    OAUTH2_JWK_CACHE_MAXSIZE = confi.int("OAUTH2_JWK_CACHE_MAXSIZE", 100, description="OAuth2 JWKS cache maxsize.")
    OAUTH2_JWK_CACHE_TTL = confi.int("OAUTH2_JWK_CACHE_TTL", 7 * 24 * 60 * 60, description="OAuth2 JWKS cache TTL.")
