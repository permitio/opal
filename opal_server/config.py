...
class OpalServerConfig(Confi):
    ...
    POLICY_REPO_CLONE_PATH = confi.str("POLICY_REPO_CLONE_PATH", os.getcwd(), description="Base path to create local git folder inside it that manage policy change")
