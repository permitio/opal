...
class OpalClientSettings:
    def __init__(
        ...
        self.opal_server_url = opal_server_url if opal_server_url else self.opal_server_url
        self.opa_port = opa_port if opa_port else self.opa_port
        self.should_report_on_data_updates = should_report_on_data_updates if should_report_on_data_updates else self.should_report_on_data_updates
        self.log_format_include_pid = log_format_include_pid if log_format_include_pid else self.log_format_include_pid
        self.inline_opa_log_format = inline_opa_log_format if inline_opa_log_format else self.inline_opa_log_format
        ...
        self.opa_health_check_policy_enabled = opa_health_check_policy_enabled if opa_health_check_policy_enabled else self.opa_health_check_policy_enabled
        self.auth_jwt_audience = auth_jwt_audience if auth_jwt_audience else self.auth_jwt_audience
        self.auth_jwt_issuer = auth_jwt_issuer if auth_jwt_issuer else self.auth_jwt_issuer
